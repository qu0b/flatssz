...
export class Hasher {
  ...
  /** Alias for finish() used by generated code. */
  hashRoot(): Uint8Array {
    return this.finish();
  }
  ...
  /** Alias for putU64 used by generated code. */
  putUint64(v: bigint): void {
    this.putU64(v);
  }
  ...
  /** Alias for appendU64 used by generated code. */
  appendUint64(v: bigint): void {
    this.appendU64(v);
  }
