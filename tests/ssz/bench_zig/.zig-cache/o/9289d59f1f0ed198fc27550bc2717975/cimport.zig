...
pub const hashtree_hash_fcn = ?*const fn ([*c]u8, [*c]const u8, u64) callconv(.C) void;
pub extern fn hashtree_init(override: hashtree_hash_fcn) c_int;
pub extern fn hashtree_hash(output: [*c]u8, input: [*c]const u8, count: u64) void;
pub extern fn hashtree_sha256_sse_x1(output: [*c]u8, input: [*c]const u8, count: u64) void;
pub extern fn hashtree_sha256_avx_x1(output: [*c]u8, input: [*c]const u8, count: u64) void;
pub extern fn hashtree_sha256_avx_x4(output: [*c]u8, input: [*c]const u8, count: u64) void;
pub extern fn hashtree_sha256_avx2_x8(output: [*c]u8, input: [*c]const u8, count: u64) void;
pub extern fn hashtree_sha256_avx512_x16(output: [*c]u8, input: [*c]const u8, count: u64) void;
pub extern fn hashtree_sha256_shani_x2(output: [*c]u8, input: [*c]const u8, count: u64) void;
